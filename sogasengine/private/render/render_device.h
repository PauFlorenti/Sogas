...
namespace Sogas 
{
    ...
    public:
        ...
        virtual void CreatePipeline(const PipelineDescriptor* desc, Pipeline* pipeline) const = 0;
        virtual void CreateAttachment() = 0;
        virtual void CreateShader(ShaderStage stage, const char* filename, Shader* shader) = 0;
